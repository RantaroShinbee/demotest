...
Public Class DataBaseAccess
    ...
    ' this line below need edit and add connection string
    Private ConnectionString As String = "Data Source=KID;Initial Catalog=demotest;Integrated Security=True"
